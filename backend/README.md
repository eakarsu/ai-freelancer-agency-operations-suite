# AI Freelancer Agency Operations Suite Backend
...
Operationally, `../start.sh` starts the working full-stack app on port 5209. This backend folder is the stable backend ownership boundary for future extraction to a standalone API service.
