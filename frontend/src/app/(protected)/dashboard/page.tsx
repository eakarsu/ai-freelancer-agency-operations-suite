...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="AI Freelancer Agency Operations Suite Dashboard"
      subtitle="One merged ai freelancer agency operations view for Proposals, Clients, Projects, Retainers, Invoices, Service Packages, Delivery Checklists, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared ai freelancer agency operations jobs into one surface. Proposals, Clients, Projects, Retainers, Invoices, Service Packages, Delivery Checklists, source tables, documents, audit, and AI are presented as platform features.
          </div>
