export const AUTH_COOKIE = 'ai_freelancer_agency_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@ai-freelancer-agency.local',
    password: 'admin123',
    firstName: 'Suite',
    lastName: 'Admin',
    role: 'admin',
  ...
  {
    email: 'manager@ai-freelancer-agency.local',
    password: 'manager123',
    firstName: 'Suite',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@ai-freelancer-agency.local',
    password: 'analyst123',
    firstName: 'Suite',
    lastName: 'Analyst',
    role: 'analyst',
